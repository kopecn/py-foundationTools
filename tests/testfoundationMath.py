...
class TestWrap:
    ...
    def test_wrap_below_range(self) -> None:
    ...
    def test_wrap_multiple_wraps_above(self) -> None:
    ...
    def test_wrap_multiple_wraps_below(self) -> None:
    ...
    def test_wrap_custom_range(self) -> None:
    ...
    def test_wrap_custom_negative_range(self) -> None:
    ...
    def test_wrap_small_range(self) -> None:
    ...
    def test_wrap_default_parameters(self) -> None:
        """Test wrap with default parameters (angle normalization)."""
        assert wrap(0) == 0
        assert wrap(pi / 2) == pi / 2
        assert wrap(-pi / 2) == -pi / 2

    def test_wrap_with_floats(self) -> None:
