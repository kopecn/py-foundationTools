# Contributing to pyFoundationTools
...
Open an issue at [GitHub Issues](https://github.com/kopecn/pyFoundationTools/issues) with:
...
Follow these steps to set up `pyFoundationTools` locally:

1. **Fork** the repository:  
   [https://github.com/kopecn/pyFoundationTools/fork](https://github.com/kopecn/pyFoundationTools/fork)

2. **Clone** your fork:

    ```sh
    git clone git@github.com:your_name_here/pyFoundationTools.git
    cd pyFoundationTools
    ```

3. **Set up a virtual environment** and install the project locally:

    ```sh
    mkvirtualenv pyFoundationTools
...
```sh
pytest tests/test_pyFoundationTools.py
```
...
Feel free to reach out or [open an issue](https://github.com/kopecn/pyFoundationTools/issues) with any questions.
