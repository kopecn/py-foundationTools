...
Open an issue at [GitHub Issues](https://github.com/kopecn/py_foundation_tools/issues) with:
...
Follow these steps to set up `py_foundation_tools` locally:

1. **Fork** the repository:  
   [https://github.com/kopecn/py_foundation_tools/fork](https://github.com/kopecn/py_foundation_tools/fork)

2. **Clone** your fork:

    ```sh
    git clone git@github.com:your_name_here/py_foundation_tools.git
    cd py_foundation_tools
    ```
...
Feel free to reach out or [open an issue](https://github.com/kopecn/py_foundation_tools/issues) with any questions.
