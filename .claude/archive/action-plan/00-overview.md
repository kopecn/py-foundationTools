...
## Math ABCs plan (chunks 21–23, 2026-07-08)

Continues the chunk numbering above as a follow-on plan (`foundation_abc/math/`
Math ABCs); the Conventions section (TDD, gate = `make uv-fullCheck`, zero
runtime deps, stay-in-scope, frontmatter, test naming) applies unchanged.
